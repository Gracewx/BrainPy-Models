...
def get_exponential(g_max=0.2, E=-60., tau=8):
    '''
        ...
        Args:
            ...
            tau (float): The time to peak of the conductance change.
    ...
    requires = {
        'ST': bp.types.SynState(['g'],help='The conductance defined by exponential function.'),
